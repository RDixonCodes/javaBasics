...
public class CarPriceEstimator {
	...
	public double getSalePrice(String makeAndModel, int yearManufactured, double milesDriven, 
		...
		if(ageOfCar <= 10) {
			salePrice = salePrice - (ageOfCar * (salePrice * .05));
		} else {
			return salePrice * .10;
		}
	...
	public static void main(String[] args) {
		...
		double salePrice = carPriceEstimator.getSalePrice("ford ecosport", 2018, 60000.0, 2, true, false, true, false, false, true);		
	}
}